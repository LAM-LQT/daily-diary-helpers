...
const Hero = () => {
  return (
    <div className="pt-20 pb-16 sm:pt-24 sm:pb-20 bg-gradient-to-b from-[#F1F0FB] to-white">
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
            ...
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <span className="block bg-gradient-to-r from-rose-400 to-purple-600 bg-clip-text text-transparent">
            ...
            <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left">
              <Button className="w-full sm:w-auto bg-gradient-to-r from-rose-400 to-purple-600 hover:from-rose-500 hover:to-purple-700 text-lg px-8 py-6 shadow-lg hover:shadow-xl transition-all duration-300">
